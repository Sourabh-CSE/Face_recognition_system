...
class Face_Recognition:
    def __init__(self,root):
        ...
        # First Image
        img_top=Image.open(r"New folder\Face2.jpg")
        ...
        # Second Image
        img_bottom=Image.open(r"New folder\Face1.jpg")
        ...
        # button
        b1_1=Button(f_lbl,text="Face Recognition",command=self.face_recog,cursor="hand2",font=("times new roman",18,"bold"),bg="darkgreen",fg= "lightblue")
        b1_1.place(x=370,y=665,width=200,height=40)
